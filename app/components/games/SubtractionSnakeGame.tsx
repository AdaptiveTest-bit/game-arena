...
import { useSubtractionSnakeStore } from '../../store/useSubtractionSnakeStore';
import SubtractionSnakeCanvas from './SubtractionSnakeCanvas';

const SubtractionSnakeGame: React.FC = () => {
  const [gameSpeed, setGameSpeed] = useState(350); // Slower speed for thinking time
    ...
    <div className={`flex flex-col items-center gap-6 p-6 bg-gradient-to-br ${getDifficultyColor()} min-h-screen`}>
      ...
      <div className="text-center">
        ...
        <p className="text-white/90 text-lg">
          Master Subtraction from 1 to 100!
        </p>
      </div>
        ...
        <div className="bg-white rounded-2xl px-8 py-4 shadow-2xl">
          <div className="text-center">
            ...
            <div className="text-4xl font-bold text-gray-800 mt-1">
              {currentQuestion.num1} - {currentQuestion.num2} = <span className="text-rose-500">?</span>
            </div>
      ...
      <div className="relative">
        <SubtractionSnakeCanvas width={600} height={600} />
      </div>
      ...
      <div className="flex items-center gap-4 bg-white/20 rounded-xl px-6 py-3">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-all ${
            gameSpeed === 500 ? 'bg-emerald-500 text-white' : 'bg-white/70 text-gray-700'
          }`}
        >
          🐢 Very Slow
        </button>
      ...
      <div className="bg-white/15 backdrop-blur-sm rounded-xl p-6 max-w-2xl text-white">
        ...
        <ul className="space-y-2 text-white/90">
          ...
          <li>• Look at the <span className="text-pink-300 font-semibold">subtraction question</span> above the snake</li>
...
export default SubtractionSnakeGame;
