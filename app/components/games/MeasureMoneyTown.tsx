...
import { generateMeasureMoney, MMQuestion } from '@/app/utils/measureMoneyGenerator';

const MeasureMoneyTown: React.FC<{ onExit?: () => void }> = ({ onExit }) => {
  ...
  useEffect(() => {
    setQuestions(generateMeasureMoney(6));
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-yellow-100 p-6">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold mb-2">Measure & Money Town</h1>
        <p className="text-sm text-gray-600 mb-4">Chapters: Length, Weight, Capacity, Money — Real-life applications</p>
...
export default MeasureMoneyTown;
